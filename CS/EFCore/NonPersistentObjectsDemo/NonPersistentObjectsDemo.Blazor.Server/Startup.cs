    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            ...
            builder.Modules
            	...
            	.Add<NonPersistentObjectsDemoBlazorModule>();
            builder.ObjectSpaceProviders
                .AddEFCore().WithDbContext<NonPersistentObjectsDemo.Module.BusinessObjects.NonPersistentObjectsDemoEFCoreDbContext>((serviceProvider, options) => {
